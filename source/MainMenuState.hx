...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(-100).loadGraphic(Paths.image('essaporraaqui'));
		bg.scrollFactor.x = 0;
		...
		magenta = new FlxSprite(-80).loadGraphic(Paths.image('encarandoatelanofundodasuaalma'));
